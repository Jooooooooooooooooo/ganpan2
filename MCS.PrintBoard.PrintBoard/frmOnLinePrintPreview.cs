...
public class frmOnLinePrintPreview : frmBase
{
	...
	public frmOnLinePrintPreview()
	{
		InitializeComponent();
	}

	private void frmOnLinePrintPreview_Load(object sender, EventArgs e)
	{
		try
		{
			OnLineBoard rpt = new OnLineBoard();
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MCS.PrintBoard.PrintBoard.frmOnLinePrintPreview));
		...
		this.arvMain.Size = new System.Drawing.Size(1196, 684);
		...
		this.tvLocatorGroup.Size = new System.Drawing.Size(1196, 684);
		...
		base.Name = "frmOnLinePrintPreview";
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "Preview";
		base.Load += new System.EventHandler(frmOnLinePrintPreview_Load);
