...
public class OfflineBoard_VerticalSize : SectionReport
{
	...
	public OfflineBoard_VerticalSize()
	{
		InitializeComponent();
	}
	...
	{
		ResourceManager resources = new ResourceManager(typeof(OfflineBoard_VerticalSize));
		detail = new Detail();
		shape2 = new Shape();
		...
		txtINSPECTION_FLAG.Left = 1.652f;
		...
		txtPART_NO.Top = 1.192f;
		txtPART_NO.Width = 2.049f;
		line9.Height = 0.9199977f;
		line9.Left = 1.527f;
		...
		line15.Name = "line15";
		line15.Top = 4.812003f;
		line15.Width = 3.59f;
		line15.X1 = 0.293f;
		line15.X2 = 3.883f;
		line15.Y1 = 4.812003f;
		line15.Y2 = 4.812003f;
		line17.Height = 3.300002f;
		line17.Left = 1.527f;
		line17.LineWeight = 1.5f;
		line17.Name = "line17";
		line17.Top = 0.8420001f;
		line17.Width = 0f;
		line17.X1 = 1.527f;
		line17.X2 = 1.527f;
		line17.Y1 = 0.8420001f;
		line17.Y2 = 4.142002f;
		...
		base.StyleSheet.Add(new StyleSheetRule("font-size: 16pt; font-weight: bold; ddo-char-set: 186", "Heading1", "Normal"));
		base.StyleSheet.Add(new StyleSheetRule("font-family: Times New Roman; font-size: 14pt; font-weight: bold; font-style: italic; ddo-char-set: 186", "Heading2", "Normal"));
